...
public class DeleteUpdateProducts extends javax.swing.JInternalFrame {
    ...
    public DeleteUpdateProducts() {
        ...
        validarManuf.setOnlyAlphaNumeric(isSelected);
        ...
        validarBarcode.setOnlyNums(isSelected);
...
@SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        cmbUnity.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "M", "M2", "M3", "UN", "CX", "DZ", "PAR", "PC", "PCT", "RL", "KG", "L", "LT", "GL", "OUTROS" }));
        cmbUnity.setEnabled(false);

        cmbType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "EPI", "MAT_ELETRICO", "MAT_HIDRAULICO1", "FERRAGNS", "MAT_CONSTRUÇÃO", "OUTROS" }));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(31, 31, 31)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtName, javax.swing.GroupLayout.PREFERRED_SIZE, 479, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSaveUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveUpdateActionPerformed
        try {
            ...
            Logger.getLogger(DeleteUpdateUser.class
...
.getName()).log(Level.SEVERE, null, ex);
    ...
    public void search() {
        ...
        try {
            ...
            Logger.getLogger(SearchProducts.class
.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void setFields() {
        ...
        cmbType.setSelectedItem(tblSearch.getModel().getValueAt(set, 3).toString());
        ...
        cmbUnity.setSelectedItem(tblSearch.getModel().getValueAt(set, 6).toString());
    ...
    private void delete() {
        ...
        int i = JOptionPane.showConfirmDialog(null, "Do you really want to delete the product (" + txtCode.getText() + ")?", "Warning", JOptionPane.OK_CANCEL_OPTION, 2);
